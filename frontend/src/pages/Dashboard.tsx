import { CheckCircleIcon, Share2Icon , ClockIcon , TrendingUpIcon , SendIcon , ActivityIcon} from 'lucide-react';
  ...
  return (
    <div  className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {statCards.map((card) => (
          <div key={card.label} className="bg-white hover:bg-primary-soft relative border border-slate-200 rounded-2xl p-5 hover:border-primary-border transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="text-3xl font-medium text-slate-800 tabular-nums">{card.value}</div>
              <div className="text-xs absolute right-4 top-4 text-primary flex items-center gap-1">
